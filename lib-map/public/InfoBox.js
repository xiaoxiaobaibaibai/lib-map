...
(function() {
     ...
     */
        ...
        this._opts.offset =  opts.offset || new BMap.Size(-5,-5);
        ...
        this._opts.closeIconUrl = opts.closeIconUrl || "white-close.svg";
    ...
    baidu.object.extend(InfoBox.prototype,{
        ...
        _adjustPosition: function(poi){
            ...
            switch(this._opts.align){
                case INFOBOX_AT_TOP:
                    if(this._marker){
                        this._div.style.bottom = -(pixel.y - this._opts.offset.height - icon.anchor.height + icon.infoWindowAnchor.height) - this._marker.getOffset().height + 18 + "px";//设置偏移量
                    }else{
        ...
        _panBox: function(){
            ...
            switch(this._opts.align){
                case INFOBOX_AT_TOP:
                    ...
                    panTop = boxH - anchorPos.y + this._opts.offset.height + h + 2 ;//InfoBox向上偏移
                    break;
                case INFOBOX_AT_BOTTOM:
                    //下侧超出
